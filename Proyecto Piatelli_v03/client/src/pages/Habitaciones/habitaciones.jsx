  ...
  const habitaciones = [
    {
      ...
      precio: "$8.000",
      descripcion:
        "Disfruta de una estadía romántica con todas las comodidades para una experiencia inolvidable.",
      descripcionCorta: "Confort y descanso asegurados.",
      capacidad: 2,
      caracteristicas: {
        superficie: "35 m²",
        cama: "Cama doble king size",
        muebles: "Incluidos",
        aireAcondicionado: true,
        tv: 'Smart TV 32"',
        wifi: "WiFi 50 Mbps",
        bano: "Baño privado con amenities",
        vista: "Vista a los viñedos de la bodega",
    ...
    },
    {
      ...
      precio: "$9.000",
      descripcion:
        "Ideal para viajeros de negocios que buscan comodidad y funcionalidad durante su estadía.",
    ...
    },
    {
      ...
      precio: "$10.000",
      descripcion:
        "Vive una experiencia única en plena naturaleza sin renunciar al confort. Nuestro glamping combina comodidad, estilo y vistas panorámicas, ofreciendo un espacio ideal para relajarte y disfrutar del entorno.",
